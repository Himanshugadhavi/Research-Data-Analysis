...
M=predict(fit1)
v=data.frame(M)
write_xlsx(v,"E:\\8. all pdf files\\research\\Data Analysis\\Mehsana_Production.xlsx")
##############################
...
expo<-minpack.lm::nlsLM(data$Production ~ a*exp(r*data$Year), 
                        data = data, 
                        start = list(a=7.956136e-156,r=0.1786065), 
